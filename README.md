...
**Cloud:** Google Cloud Platform (ACE Certified) • AWS (EKS, MSK, EC2, RDS) • Docker • Kubernetes  
**AI / GenAI:** LangChain • LangGraph • Pinecone • RAG • Agents • LLM Tool-Calling • OpenAI API  
**Databases:** PostgreSQL • MongoDB • MySQL • Redis  
**DevOps:** Git • GitHub Actions • GitLab CI/CD • Jenkins • Terraform • Kafka  
**Testing:** JUnit • Jest • Selenium • TestNG • Cucumber  
...
📌 *July 2024 - Present* • San Francisco, CA (Remote)  
...
📌 *September 2021 - August 2023* • Bangalore, India  
...
### 💳 [Verifi — Offline Peer-to-Peer Payment Verification](https://github.com/satishparaddi/verifi)
**🏆 Hackathon Winner | Offline AI-Powered Payment System**
...
**Tech Stack:** Python • Flutter • Bluetooth • QR Codes • On-Device LLM • Vision AI
...
### 🧠 [Multi-Agent Financial Research Assistant](https://github.com/satishparaddi/MultiAgent-RAG)
**📹 [Watch Demo](https://drive.google.com/file/d/1t5IDI6mKTD-oxKhGdWrRxHmNsQs4JnjP/view) | Advanced AI Orchestration System**
...
**Tech Stack:** LangGraph • LangChain • Pinecone • Snowflake • FastAPI • Docker
...
### 🎵 [Music API Rate Limiter — Production-Grade Throttling System](https://github.com/satishparaddi/music-api-rate-limiter)
...
**Tech Stack:** Java 17 • Spring Boot 3 • ConcurrentHashMap • Maven
...
- **Thread-safe concurrency** - `ConcurrentHashMap` + synchronized blocks preventing race conditions
- **8 Design Patterns** - Strategy, Observer, Factory, Singleton, Decorator, Command, State, Builder
...
### 💬 [Expertease — Expert Booking Platform](https://github.com/satishparaddi/ExpertEase)
**📹 [Watch Demo](https://drive.google.com/file/d/1Rc-XL6JkRQbcib-0-kT_aHwe7s2u3Sds/view) | Full-Stack Application**
...
### ☁️ [Infra-Automation — Cloud-Native Infrastructure](https://github.com/satishparaddi/infra-automation)
**GCP • Terraform • Docker • Kubernetes • GitHub Actions**
...
### 🛒 [Retail AI — AI-Powered E-Commerce Platform](https://github.com/satishparaddi/retail-ai)
**Spring Boot • OpenAI API • PostgreSQL • React • JWT**
...
### 🐾 [PetConnect — Pet Adoption Platform](https://github.com/satishparaddi/petconnect)
**MERN Stack • RESTful APIs • MongoDB Atlas**
...
🏅 **Google Cloud Associate Cloud Engineer** - Certified cloud infrastructure architect
...
🎓 Recently completed: **MS in Information Systems from Northeastern University (April 2025)**
...
- 🍳 **Cooking** - Experimenting with fusion recipes from different cuisines
- 💪 **At the gym** - Staying fit and clearing my mind
- 🥾 **Trekking** - Exploring nature trails around New England
- 🤝 **Foster care** - Volunteering with local community programs
...
[![Profile Views](https://komarev.com/ghpvc/?username=satishparaddi&color=blue&style=flat)](https://github.com/satishparaddi)
